...
public class CancelQueueRequestByOperatorActionTest extends ActionTestCase {
    private CancelQueueRequestByOperatorActionNode actionNode;
    
    @Before
    public void prepare() {
        actionNode = new CancelQueueRequestByOperatorActionNode();
