...
public class UnMuteConferenceParticipantActionTest extends ActionTestCase {
    private UnMuteConferenceParticipantActionNode actionNode;
    
    @Before
    public void prepare() {
        actionNode = new UnMuteConferenceParticipantActionNode();
        actionNode.setName("unmute action");
