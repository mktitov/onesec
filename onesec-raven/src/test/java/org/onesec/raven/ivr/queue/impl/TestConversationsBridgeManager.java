 ...
 */
public class TestConversationsBridgeManager extends BaseNode implements IvrConversationsBridgeManager
{
    private IvrConversationsBridgeManager manager;

    public IvrConversationsBridgeManager getManager() {
        return manager;
    }

    public void setManager(IvrConversationsBridgeManager manager) {
