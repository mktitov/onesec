...
public class ConnectToConferenceActionTest extends ActionTestCase {
    private ConnectToConferenceActionNode actionNode;
    
    @Before
    public void prepare() {
        actionNode = new ConnectToConferenceActionNode();
        actionNode.setName("connect to conference");
