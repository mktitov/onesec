...
public class CancelQueueCallRequestActionTest extends ActionTestCase {
    private CancelQueueCallRequestActionNode actionNode;
    
    @Before
    public void prepare() {
        actionNode = new CancelQueueCallRequestActionNode();
        actionNode.setName("cancel action");
    ...
    public void test(
            ...
            @Mocked final QueuedCallStatus queueState) 
        throws Exception 
    {
        new Expectations() {{
            ...
            bindings.get(QueueCallAction.QUEUED_CALL_STATUS_BINDING); result = queueState;            
        }};
