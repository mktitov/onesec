...
import org.onesec.raven.ivr.SipTerminalState;

/**
 *
 * @author Mikhail Titov
 */
public class SipTerminalStateImpl extends BaseState<SipTerminalState, SipTerminal> implements SipTerminalState {

    public SipTerminalStateImpl(SipTerminal observableObject) {
