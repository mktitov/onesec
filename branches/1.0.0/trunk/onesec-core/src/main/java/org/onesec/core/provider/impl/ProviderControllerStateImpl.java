 ...
 */
public class ProviderControllerStateImpl 
        extends BaseState<ProviderControllerState, ProviderController>
        implements ProviderControllerState{

    public ProviderControllerStateImpl(ProviderController providerController) {
