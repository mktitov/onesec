 ...
 */
public class ReserveEndpointRequestImpl implements ReserveEndpointRequest {
    private final long timeout;
    private final ConversationScenario conversationScenario;

    public ReserveEndpointRequestImpl(long timeout, ConversationScenario conversationScenario) {
        this.timeout = timeout;
        this.conversationScenario = conversationScenario;
    }

    public ReserveEndpointRequestImpl(long timeout) {
        this(timeout, null);
    }
