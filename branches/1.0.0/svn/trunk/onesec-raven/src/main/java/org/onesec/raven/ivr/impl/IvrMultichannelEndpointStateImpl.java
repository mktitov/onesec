 ...
 */
public class IvrMultichannelEndpointStateImpl
        extends BaseState<IvrMultichannelEndpointState, IvrMultichannelEndpoint>
        implements IvrMultichannelEndpointState
{
    public IvrMultichannelEndpointStateImpl(IvrMultichannelEndpoint observableObject)
    {
